...
const ROLE_PALETTE: Record<
  CupRole,
  { top: string; bottom: string; rim: string; shadow: string; ring?: string }
> = {
  ...
  "block-corner": {
    ...
    ring: "0 0 0 2px rgba(252,211,77,0.55)",
  },
  "row-target": {
    top: "#fcd34d",
    bottom: "#a16207",
  ...
  "relocate-dst-eligible": {
    ...
    bottom: "#166534",
    rim: "#15803d",
    shadow: "rgba(134,239,172,0.45)",
    ring: "0 0 0 2px rgba(134,239,172,0.5)",
  },
};
    ...
    >
      ...
      {!isFlipped && (
        <span
          className={[
            "cup-3d",
            role === "idle" || role === "placement-disabled"
              ? ""
              : "cup-3d-bob",
      ...
      {isFlipped && (
        <span
          className={`cup-reveal ${isSpider ? "cup-reveal-spider" : "cup-reveal-empty"}`}
          aria-hidden
        >
          {isSpider ? (
