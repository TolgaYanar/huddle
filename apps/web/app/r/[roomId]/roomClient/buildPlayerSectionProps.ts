...
export function buildPlayerSectionProps(args: {
  ...
  return {
    ...
    isTier3: videoEmbed.isTier3,
    isDailymotion: videoEmbed.isDailymotion,
    dailymotionEmbedSrc: videoEmbed.dailymotionEmbedSrc,
    isSoundCloud: videoEmbed.isSoundCloud,
    soundCloudEmbedSrc: videoEmbed.soundCloudEmbedSrc,
    isLoom: videoEmbed.isLoom,
    loomEmbedSrc: videoEmbed.loomEmbedSrc,
    isPeerTube: videoEmbed.isPeerTube,
    peerTubeEmbedSrc: videoEmbed.peerTubeEmbedSrc,
